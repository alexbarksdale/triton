...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"src/apis/triton.ts":[function(require,module,exports) {
"use strict";
...
var triton_1 = __importDefault(require("../apis/triton"));
...
function () {
  ...
  User.prototype.fetch = function () {
    ...
    triton_1.default.get("/users/" + this.get('id')).then(function (res) {
      _this.set(res.data);
    }).catch(function (err) {
  ...
  User.prototype.save = function () {
    ...
    if (id) {
      triton_1.default.put("/users/" + id, this.data);
    } else {
      triton_1.default.post('/users', this.data);
    }
  };
...
exports.User = User;
},{"../apis/triton":"src/apis/triton.ts"}],"src/index.ts":[function(require,module,exports) {
"use strict";
